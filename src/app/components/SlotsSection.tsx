    ...
    <section className="bg-[#1b0225] py-12 md:py-16 lg:py-20 relative">
      <div className="max-w-[1400px] mx-auto px-4 md:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 md:mb-8 gap-4">
          <div className="text-3xl md:text-4xl lg:text-5xl font-bold text-white">Slots</div>
          <a
        ...
        <p className="text-white text-base md:text-lg mb-8 md:mb-12 max-w-[900px]">
          Our multi-award winning slots portfolio contains unique in-house content consisting of
          over 500 games, available in all major currencies, languages and certified markets.
        </p>
