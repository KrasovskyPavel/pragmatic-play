    ...
    <section className="bg-white py-12 md:py-16 lg:py-20 px-4 md:px-8">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="mb-8 md:mb-12">
          <h2 className="text-xl md:text-3xl lg:text-4xl font-bold text-black mb-3 md:mb-4">
            What is Pragmatic Play?
          </h2>
          <h3 className="text-lg md:text-xl lg:text-2xl text-gray-800 mb-3 md:mb-4">
          ...
          <ul className="space-y-2 md:space-y-3 mb-4 md:mb-6">
            <li className="text-gray-700 text-sm md:text-base flex items-start">
              ...
              <span>Cutting-edge graphics and animations</span>
            </li>
            <li className="text-gray-700 text-sm md:text-base flex items-start">
              <span className="text-orange-500 mr-2 font-bold">•</span>
              <span>Seamless performance on both desktop and mobile devices</span>
            </li>
            <li className="text-gray-700 text-sm md:text-base flex items-start">
              <span className="text-orange-500 mr-2 font-bold">•</span>
              <span>The availability of free play versions for testing and practice</span>
            </li>
            <li className="text-gray-700 text-sm md:text-base flex items-start">
              <span className="text-orange-500 mr-2 font-bold">•</span>
              <span>High RTP rates and engaging bonus features</span>
            </li>
          </ul>
          <p className="text-gray-700 text-sm md:text-base leading-relaxed mb-4 md:mb-6">
          ...
          <div className="bg-gray-50 p-4 md:p-6 rounded-xl border border-gray-200">
            ...
            <ul className="space-y-2">
              ...
              <li className="text-gray-700 text-sm md:text-base flex items-start">
                <span className="text-orange-500 mr-2 flex-shrink-0">✓</span>
                <span>User-friendly interface suitable for beginners and experienced players.</span>
              </li>
              <li className="text-gray-700 text-sm md:text-base flex items-start">
                <span className="text-orange-500 mr-2 flex-shrink-0">✓</span>
                <span>Demo mode allows risk-free exploration of new games.</span>
              </li>
              <li className="text-gray-700 text-sm md:text-base flex items-start">
                <span className="text-orange-500 mr-2 flex-shrink-0">✓</span>
                <span>High-quality graphics and smooth animations enhance gameplay.</span>
              </li>
              <li className="text-gray-700 text-sm md:text-base flex items-start">
                <span className="text-orange-500 mr-2 flex-shrink-0">✓</span>
                <span>Reliable performance across mobile and desktop devices.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-8 md:mb-12">
          ...
          {/* Table */}
          <div className="overflow-x-auto mb-6 md:mb-8 rounded-lg border border-gray-200">
          ...
          <div className="bg-gray-50 p-4 md:p-6 rounded-xl border border-gray-200">
            ...
            <ul className="space-y-2">
              <li className="text-gray-700 text-sm md:text-base flex items-start">
                <span className="text-orange-500 mr-2 flex-shrink-0">✓</span>
                <span>Engaging gameplay and interactive features</span>
              </li>
              <li className="text-gray-700 text-sm md:text-base flex items-start">
                <span className="text-orange-500 mr-2 flex-shrink-0">✓</span>
                <span>High-quality visual and sound effects</span>
              </li>
              <li className="text-gray-700 text-sm md:text-base flex items-start">
                <span className="text-orange-500 mr-2 flex-shrink-0">✓</span>
                <span>Bonus rounds and multipliers that increase winning potential</span>
              </li>
              <li className="text-gray-700 text-sm md:text-base flex items-start">
                <span className="text-orange-500 mr-2 flex-shrink-0">✓</span>
                <span>Variety of betting ranges suitable for different types of players</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mb-8 md:mb-12">
          ...
          <div className="bg-gray-50 p-4 md:p-6 rounded-xl border border-gray-200 mb-4 md:mb-6">
            ...
            <ol className="space-y-2">
              <li className="text-gray-700 text-sm md:text-base flex items-start">
                <span className="text-orange-500 mr-3 font-bold flex-shrink-0">1.</span>
                <span>Select a Pragmatic Play slot.</span>
              </li>
              <li className="text-gray-700 text-sm md:text-base flex items-start">
                <span className="text-orange-500 mr-3 font-bold flex-shrink-0">2.</span>
                <span>Launch the game in demo mode.</span>
              </li>
              <li className="text-gray-700 text-sm md:text-base flex items-start">
                <span className="text-orange-500 mr-3 font-bold flex-shrink-0">3.</span>
                <span>Play using virtual credits to explore features and bonuses.</span>
              </li>
            </ol>
          </div>
          ...
          <ul className="space-y-2">
            <li className="text-gray-700 text-sm md:text-base flex items-start">
              <span className="text-orange-500 mr-2 flex-shrink-0">✓</span>
              <span>No financial risk while learning new games</span>
            </li>
            <li className="text-gray-700 text-sm md:text-base flex items-start">
              <span className="text-orange-500 mr-2 flex-shrink-0">✓</span>
              <span>Opportunity to explore all bonus features</span>
            </li>
            <li className="text-gray-700 text-sm md:text-base flex items-start">
              <span className="text-orange-500 mr-2 flex-shrink-0">✓</span>
              <span>Understanding paylines and mechanics before betting real money</span>
            </li>
            <li className="text-gray-700 text-sm md:text-base flex items-start">
              <span className="text-orange-500 mr-2 flex-shrink-0">✓</span>
              <span>Testing different strategies and betting amounts</span>
            </li>
          </ul>
        </div>
        ...
        <div className="mb-8 md:mb-12">
          ...
          <ul className="space-y-2">
            <li className="text-gray-700 text-sm md:text-base flex items-start">
              <span className="text-orange-500 mr-2 flex-shrink-0">✓</span>
              <span>Quick load times for instant play</span>
            </li>
            <li className="text-gray-700 text-sm md:text-base flex items-start">
              <span className="text-orange-500 mr-2 flex-shrink-0">✓</span>
              <span>Easy-to-use touch controls</span>
            </li>
            <li className="text-gray-700 text-sm md:text-base flex items-start">
              <span className="text-orange-500 mr-2 flex-shrink-0">✓</span>
              <span>Full access to demo and real money modes</span>
            </li>
            <li className="text-gray-700 text-sm md:text-base flex items-start">
              <span className="text-orange-500 mr-2 flex-shrink-0">✓</span>
              <span>Consistent gameplay across devices</span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-gray-50 p-6 md:p-8 rounded-2xl border border-gray-200">
          <h2 className="text-xl md:text-3xl lg:text-4xl font-bold text-black mb-6 md:mb-8 text-center">
