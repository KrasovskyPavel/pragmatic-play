        ...
        <footer className="bg-[#1b0225] pt-12 md:pt-16 lg:pt-20 pb-6 md:pb-8">
            <div className="max-w-[1400px] mx-auto px-4 md:px-8">
                ...
                <div className="text-center text-gray-400 text-xs md:text-sm mb-6 md:mb-8 px-4 leading-relaxed max-w-4xl mx-auto">
                    <p>
                        COPYRIGHT © 2015 – 2026. All rights reserved to
                        Pragmatic Play, a{' '}
                        <a
                            href="#"
                        ...
                        investment. Any and all content included on this website
                        or incorporated by reference is protected by
                ...
                <div className="text-center text-gray-400 text-xs px-4 leading-relaxed max-w-3xl mx-auto">
                    <p>
                        PragmaticPlay (Gibraltar) Limited is licensed by the
                        Gibraltar Licensing Authority and regulated under the
                        Act by the Gibraltar Gambling Commissioner, under RGL
                        No. 107.
                    </p>
                </div>
            </div>
